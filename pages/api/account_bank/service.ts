...
export async function s_get() {
  try {
    ...
    return wr(200, `Get data account bank success`, result)
  } catch (error: any) {
...
export async function s_getDetail(id: number) {
  try {
    ...
    if('error' in result) return wr(500, `Opss something's wrong!`, result)
    return wr(200, `Get data account bank with id ${id} success`, result)
  } catch (error: any) {
    return wr(500, `Opss something's wrong!`, error)
  }
}
...
export async function s_store(req: Request) {
  try {
    ...
    if('error' in result) return wr(500, `Opss something's wrong!`, result)
    return wr(200, `Insert data account bank success`, result)
  } catch (error: any) {
    return wr(500, `Opss something's wrong!`, error)
  }
}
export async function s_update(req: Request, id: number) {
  try {
    ...
    if('error' in result) return wr(500, `Opss something's wrong!`, result)
    return wr(200, `Update data account bank with id ${id} success`, result)
  } catch (error: any) {
    return wr(500, `Opss something's wrong!`, error)
  }
}
...
export async function s_remove(id: number) {
  try {
    ...
    if('error' in result) return wr(500, `Opss something's wrong!`, result)
    return wr(200, 'Delete data account bank success', result)
  } catch (error: any) {
    return wr(500, `Opss something's wrong!`, error)
  }
}