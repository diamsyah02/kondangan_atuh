...
export async function s_get() {
  try {
    ...
    return wr(200, `Get data dalil ayat success`, result)
  } catch (error: any) {
...
export async function s_getDetail(id: number) {
  try {
    ...
    if('error' in result) return wr(500, `Opss something's wrong!`, result)
    return wr(200, `Get data dalil ayat with id ${id} success`, result)
  } catch (error: any) {
    return wr(500, `Opss something's wrong!`, error)
  }
}
...
export async function s_store(req: Request) {
  try {
    ...
    if('error' in result) return wr(500, `Opss something's wrong!`, result)
    return wr(200, `Insert data dalil ayat success`, result)
  } catch (error: any) {
    return wr(500, `Opss something's wrong!`, error)
  }
}
export async function s_update(req: Request, id: number) {
  try {
    ...
    if('error' in result) return wr(500, `Opss something's wrong!`, result)
    return wr(200, `Update data dalil ayat with id ${id} success`, result)
  } catch (error: any) {
    return wr(500, `Opss something's wrong!`, error)
  }
}
...
export async function s_remove(id: number) {
  try {
    ...
    if('error' in result) return wr(500, `Opss something's wrong!`, result)
    return wr(200, 'Delete data dalil ayat success', result)
  } catch (error: any) {
    return wr(500, `Opss something's wrong!`, error)
  }
}